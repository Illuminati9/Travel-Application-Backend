...
const BusDetailsModel = require('../models/busDetails.model')
...
const SeatFloorModel = require('../models/seatFloor.model')
const SeatRowModel = require('../models/seatRow.model')
const SeatAvailableModel = require('../models/seatAvailable.model')
